...
namespace ProyectoPurasol.Models
{
    public class PrincipalRes
    {
        ...
        public double REne { get; set; }
        public double RFeb { get; set; }
        public double RMar { get; set; }
        public double RAbr { get; set; }
        public double RMay { get; set; }
        public double RJun { get; set; }
        public double RJul { get; set; }
        public double RAgo { get; set; }
        public double RSep { get; set; }
        public double ROct { get; set; }
        public double RNov { get; set; }
        public double RDic { get; set; }
        public double RSGISEne { get; set; }
