...
namespace ProyectoPurasol.Models
{
    public class Principal
    {
        ...
        public string UnificacionMenor3000 { get; set; }
        public string CeroInyeccion { get; set; }
        ...
        public double Conversor { get; set; }
        public double AlmacenamientoFijo { get; set; }
        ...
        public double RSGISMay { get; set; }
