...
namespace BLL
{
    public class clsInformacion //clase Información.
    {
        ...
        public List<CantonesResult> ObtenerCantones(int Provincia) //Método para obtener cantones 
        {
            DatosDataContext db = new DatosDataContext();           //Instanciar la Base de Datos.
        ...
        public List<DistritosResult> ObtenerDistritos(int Provincia,int Canton) //Método para obtener distritos.
        {
            DatosDataContext db = new DatosDataContext(); //Instanciar la Base de Datos.
