...
namespace BLL
{
    public class clsPreliminares
    {
        ...
        public void calculaCostosCom(double tamano, string tecnologia, double tipoCambio, string Microred, double Almacenamiento, string costoUnitatioFijo, string costoUnitatioFijoValor, List<List<double>> listaFinanciamientos, clsCalculosCom calculos, List<clsCostosUnitarios> costos)
        {
        ...
        public void calculaRestoCom(double tipoCambio, string costoUnitatioFijo, string costoUnitatioFijoValor, string costoMantenimiento, clsCalculosCom calculos, clsCostosMant cMant)
        {
            double[] sumTotal = new double[11];
            double sumVAN = 0;
