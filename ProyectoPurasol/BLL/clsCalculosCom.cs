...
namespace BLL
{
    public class clsCalculosCom
    {
        ...
        public void calculosCom(double PREne, double PRFeb, double PRMar, double PRAbr, double PRMay, double PRJun, double PRJul, double PRAgo, double PRSep, double PROct, double PRNov, double PRDic, double PRSGISEne,
            ...
            double PromedioRecibos, double PromedioSGIS, double crecimientoAnual, string Compania, string Tarifa, clsCurvasCom curvas, List<double> pico, string UnificacionMenor3000, string CeroInyeccion)
        {
            ...
            if (UnificacionMenor3000=="Sí")
            {
                tarifas.COCNFL3000Menos = 73.12;
                tarifas.CSCNFL3000Mas = 47.1;
                tarifas.CSCNFL08 = 61003.4;
                tarifas.CSCNFL815 = 7625.42;
                tarifas.CSCNFL15Mas = 7625.42;
                tarifas.CSESPH3000Mas = 56.91;
                tarifas.CSESPH08 = 88821.1;
                tarifas.CSESPH815 = 88821.1;
                tarifas.CSESPH15Mas = 88821.1;

                if (CeroInyeccion=="No")
                {
                    tarifas.ACNFLTA = 21.03;
                }
                else
                {
                    tarifas.AICETA = 124.98;
                    tarifas.ACNFLTA = 121.46;
                    tarifas.AJASECTA = 100.4;
                    tarifas.AESPHTA = 113.82;
                    tarifas.ACOOPELTA = 98.47;
                    tarifas.ACOOPEGTA = 103.12;
                    tarifas.ACOOPESTA = 164.35;
                    tarifas.ACOOPEATA = 109.91;
                }
            ...
            {
                tarifas.COICE3000Mas = 124.98;
                tarifas.COCNFL3000Mas = 121.46;
                tarifas.COJASEC3000Mas = 100.4;
                tarifas.COESPH3000Mas = 113.82;
                tarifas.COCOOPEL3000Mas = 98.47;
                tarifas.COCOOPEG3000Mas = 103.12;
                tarifas.COCOOPES3000Mas = 164.35;
                tarifas.COCOOPEA3000Mas = 109.91;

                tarifas.COICE08 = 0;
                tarifas.COICE810 = 0;
                tarifas.COICE1015 = 0;
                tarifas.COICE15Mas = 0;
                tarifas.COCNFL08 = 0;
                tarifas.COCNFL810 = 0;
                tarifas.COCNFL1015 = 0;
                tarifas.COCNFL15Mas = 0;
                tarifas.COJASEC08 = 0;
                tarifas.COJASEC810 = 0;
                tarifas.COJASEC1015 = 0;
                tarifas.COJASEC15Mas = 0;
                tarifas.COESPH08 = 0;
                tarifas.COESPH810 = 0;
                tarifas.COESPH1015 = 0;
                tarifas.COESPH15Mas = 0;
                tarifas.COCOOPEL08 = 0;
                tarifas.COCOOPEL810 = 0;
                tarifas.COCOOPEL1015 = 0;
                tarifas.COCOOPEL15Mas = 0;
                tarifas.COCOOPEG08 = 0;
                tarifas.COCOOPEG810 = 0;
                tarifas.COCOOPEG1015 = 0;
                tarifas.COCOOPEG15Mas = 0;
                tarifas.COCOOPES08 = 0;
                tarifas.COCOOPES810 = 0;
                tarifas.COCOOPES1015 = 0;
                tarifas.COCOOPES15Mas = 0;
                tarifas.COCOOPEA08 = 0;
                tarifas.COCOOPEA810 = 0;
                tarifas.COCOOPEA1015 = 0;
                tarifas.COCOOPEA15Mas = 0;
                tarifas.CSICE3000Mas = 84;
                tarifas.CSICE08 = 0;
                tarifas.CSICE815 = 0;
                tarifas.CSICE15Mas = 0;
                tarifas.CSCNFL3000Mas = 81.8;
                tarifas.CSCNFL08 = 0;
                tarifas.CSCNFL815 = 0;
                tarifas.CSCNFL15Mas = 0;
                tarifas.CSJASEC3000Mas = 72.24;
                tarifas.CSJASEC08 = 0;
                tarifas.CSJASEC815 = 0;
                tarifas.CSJASEC15Mas = 0;
                tarifas.CSESPH3000Mas = 82.54;
                tarifas.CSESPH08 = 0;
                tarifas.CSESPH815 = 0;
                tarifas.CSESPH15Mas = 0;
                tarifas.CSCOOPES3000Mas = 164.35;
                tarifas.CSCOOPES08 = 0;
                tarifas.CSCOOPES815 = 0;
                tarifas.CSCOOPES15Mas = 0;
            ...
            for (int i = 0; i < 26; i++)
            {
                ...
                for (int j = 1; j < 13; j++)
                {
                    if (compraReg[i, j] < 3000)
                    {
                        costoPredichoEner[i, j] = compraReg[i, j] * tarCO[0] * calculos[i,6]+  enerCoberturTarAcc[i,j]* tarCO[2] * calculos[i, 6];
                    }
                    else
                    {
                        costoPredichoEner[i, j] = compraReg[i, j] * tarCO[1] * calculos[i, 6] + enerCoberturTarAcc[i, j] * tarCO[2] * calculos[i, 6];
                    }
            ...
            //llenar la matriz de costo predico (potencia)
            ...
            for (int i = 0; i < 26; i++)
            {
                ...
                for (int j = 1; j < 13; j++)
                {
                    if ((comprado[i, j]/calculos[i,3]) < 3000)
                    {
